...
$(document).ready(function(){
	$(".main-block").animated("fadeInDown");
	$(".head").animated("fadeInDown");
	$(".header").animated("zoomIn");
	$(".amimate-block").animated("fadeInUp");
	$(".expand-contant").animated("fadeInUp");
	$(".magnific").animated("fadeInLeft");
	$(".left").animated("fadeInLeft");
	$(".right").animated("fadeInRight");
	$(".centr").animated("flipInY");
